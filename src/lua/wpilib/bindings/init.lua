...
void* PWM_new(int channel);
void PWM_SetBounds(void* _this, double max, double deadbandMax, double center, double deadbandMin, double min);
void PWM_SetSpeed(void* _this, double value);
double PWM_GetSpeed(void* _this);
