...
GenFuncResult GenFunc(ParseFuncResult res, MD_String8 customReturnType, MD_String8 customName, MD_String8 defaultBody) {
        ...
        while (1) {
            ...
            if (MD_NodeHasTag(fentry, MD_S8Lit("class"))) {
                ...
                while (1) {
                    ...
                    GenFuncResult genRes = GenFunc(res, returnType, name, body);
                ...
                GenFuncResult genRes = GenFunc(res, MD_S8Lit(""), MD_S8Lit(""), MD_S8Lit(""));
                MD_PushStringToList(&cppDefs, genRes.CppDef);
                MD_PushStringToList(&luaDefs, genRes.LuaDef);
